    ...
    <>
      <header className="header wrapper">
        ...
        <div className="header__user">
          <span className="user__name">Incognito</span>
          <a href="#" className="user__profile-picture">
            <img src="img/user-avatar1.jpg" alt="profile picture" />
          </a>
        </div>
      </header>
      ...
      <section className="messenger wrapper">
        ...
        <div className="messenger__input-line">
          <form action='' className="input-line__form">
            <textarea name='form__message' id="form__message" cols={30} rows={10} className="form__message" defaultValue={'\n        '} />
          </form>
        </div>
        <div className="messenger__buttons-section">
          <button className="buttons-section__send">Send</button>
        </div>
      </section>
    </>
  );
